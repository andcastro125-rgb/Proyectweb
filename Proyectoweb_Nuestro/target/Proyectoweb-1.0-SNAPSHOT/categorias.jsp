  ...
  <section class="categories-page">
    ...
    <div class="categories-page__content">
      ...
      <div class="category-grid">
        ...
        <%-- CAFETERÍA — coloca cafeteria.jpg en web/images/ (400x400px, latte art) --%>
        ...
        <%-- PANADERÍA — coloca panaderia.jpg en web/images/ (400x400px, galleta) --%>
        ...
        <%-- CHOCOLATE — coloca chocolate.jpg en web/images/ (400x400px, taza dark) --%>
        ...
        <%-- DONAS — coloca donas.jpg en web/images/ (400x400px, dona rosa) --%>
