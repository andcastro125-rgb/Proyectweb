...
<head>
  ...
  <title>OptiCafé — Agregar Producto</title>
  ...
  <section class="crud-page">
    ...
    <div class="crud-page__content">
      <div class="crud-page__header fade-up">
        ...
        <p>Agrega los siguientes datos para agregar un Producto nuevo</p>
      </div>
      <%
      ...
      <form method="post" action="agregarProducto">
        ...
        <div class="crud-field fade-up fade-up-delay-3">
          ...
          <input type="number" id="precio" name="precio" step="0.01" min="0" required autocomplete="off"/>
        </div>
