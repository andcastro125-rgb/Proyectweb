...
<head>
  ...
  <title>OptiCafé — Editar Producto</title>
  ...
  <section class="crud-page">
    ...
    <div class="crud-page__content">
      <div class="crud-page__header fade-up">
        ...
        <p>Ingresa datos del producto para editar su información</p>
      </div>
      <%
      ...
      <form method="post" action="editarProducto">
        ...
        <div class="crud-field fade-up fade-up-delay-3">
          ...
          <input type="number" id="nuevoPrecio" name="nuevoPrecio" step="0.01" min="0" required autocomplete="off"/>
        </div>
